...
function wait_for_state() {
    ...
    local state="$2"
    local timeout="$3"
    local namespace="${4:-${NAMESPACE:-openstack-kuttl-tests}}"
...
function create_selfsigned_issuer() {
    local namespace="${1:-${NAMESPACE:-openstack-kuttl-tests}}"
...
function create_custom_issuer() {
    ...
    local namespace="${2:-${NAMESPACE:-openstack-kuttl-tests}}"
...
function create_service_route_certificate() {
    ...
    local namespace="${3:-${NAMESPACE:-openstack-kuttl-tests}}"
